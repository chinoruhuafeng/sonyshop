...
<body>
  ...
  <main>
    <center><h1 class="featurette-heading">Categoria de fuente</h1></center>
    ...
    <div class="container marketing">
      ...
      $articulos=mysqli_query($conexion,"SELECT refracion.id AS id,
        ...
        where refracion.id_categoria='3';");
        ...
        $busqueda=mysqli_query($conexion,"SELECT refracion.id AS id,
          ...
          INNER JOIN cuarto ON locacion.id_cuarto= cuarto.id
          INNER JOIN seccion ON locacion.id_seccion = seccion.id
          where refracion.id_categoria='3' LIMIT $inicio,$registros;");
        ...
        <ul class="pagination pg-dark justify-content-center pb-5 pt-5 mb-0" style="float: none;" >
          <li class="page-item">
            ...
            if($_REQUEST["nume"] == "1" ){
              ...
              if ($pagina>1)
              $ant = $_REQUEST["nume"] - 1;
              echo "<a class='page-link' aria-label='Previous' href='fuentes.php?nume=1'><span aria-hidden='true'>&laquo;</span><span class='sr-only'>Previous</span></a>";
              echo "<li class='page-item '><a class='page-link' href='fuentes.php?nume=". ($pagina-1) ."' >".$ant."</a></li>"; }
              ...
              if ($ultima == $_REQUEST["nume"] +1 ){
                ...
                echo "<li class='page-item'><a class='page-link' href='fuentes.php?nume=". ($pagina+1) ."'>".$sigui."</a></li>";
                if ($pagina<$paginas && $paginas>1)
                echo "
                <li class='page-item'><a class='page-link' aria-label='Next' href='fuentes.php?nume=". ceil($ultima) ."'><span aria-hidden='true'>&raquo;</span><span class='sr-only'>Next</span></a>
                </li>";
                ?>
              </ul>
            </div>
