  ...
  <main>
    ...
    if (isset($_GET['buscar'] )) {
      ...
      $consulta=$conexion->query("SELECT refracion.id AS id,
        ...
        where categoria.descripcion LIKE '$txt_nombre%' || marca.marca LIKE '$txt_nombre%' || modelo.modelo LIKE '$txt_nombre%' || refracion.version LIKE '$txt_nombre%' ");
        ?>
        <center><h1 class="featurette-heading">Realizaste la busqueda por:<?php echo $txt_nombre; ?> </h1></center>
