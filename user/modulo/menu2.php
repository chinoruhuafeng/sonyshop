  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          if($resultado->num_rows > 0){
            while($row = $resultado->fetch_assoc()){
              ?>
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="../categoria/categoria.php?id=<?php echo $row['id']; ?>"><?php echo $row['descripcion']; ?></a>
          </li>
          <?php
      ...
      ?>
        ...
        &nbsp
        <form class="d-flex" action="../consultas/busqueda.php" method="GET">
